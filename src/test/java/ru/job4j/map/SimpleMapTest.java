...
class SimpleMapTest {
    ...
    @Test
    void whenPutAndExpand() {
        assertThat(map.put(7, "seventh")).isTrue();
        assertThat(map.put(6, "sixth")).isTrue();
        assertThat(map.put(5, "fifth")).isTrue();
    ...
    void whenPutDuplicate() {
        assertThat(map.put(5, "fifth")).isTrue();
        assertThat(map.put(5, "twenty")).isFalse();
        assertThat(map.put(6, "sixth")).isTrue();
        assertThat(map.put(7, "sixth")).isTrue();
    }

    @Test
    void whenGetNull() {
        assertThat(map.get(1)).isEqualTo("1");
        assertThat(map.get(15)).isEqualTo(null);

    }

    @Test
    void whenGetAllMapAndMore() {
        assertThat(map.get(4)).isEqualTo("4");
        assertThat(map.get(3)).isEqualTo("3");
        assertThat(map.get(2)).isEqualTo("2");
        assertThat(map.get(1)).isEqualTo("1");
        assertThat(map.get(100)).isEqualTo(null);
        assertThat(map).hasSize(4);
    }

    @Test
    void whenRemoveKeyAndRemoveNull() {
    ...
    @Test
    void whenRemoveAllAndCheckSize() {
