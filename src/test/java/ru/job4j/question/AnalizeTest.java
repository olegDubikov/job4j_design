...
class AnalizeTest {
    ...
    @Test
    void whenDeleteAndAdd() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(u2, u3, new User(4, "D"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(1, 0, 1));
    }
    ...
    void whenChangedAndDelete() {
        ...
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
        Set current = Set.of(u1, new User(3, "CC"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(0, 1, 1));
    }
}